...
static int rk29_rt5621_detect_device(struct i2c_client *i2c)
{
	u8 data[2]={0};
	unsigned int value=0x0;
	int ret;

	ret = i2c_master_reg8_recv(i2c, RT5621_VENDOR_ID1, data, 2,100 * 1000);   
	if(ret < 0){
		printk("%s: read RT5621_VENDOR_ID1 err!\n", __FUNCTION__);
		return -ENODEV;
	}
