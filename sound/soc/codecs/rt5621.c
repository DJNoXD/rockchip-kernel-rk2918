...
static struct rt5621_init_reg init_data[] = {
	...
	{RT5621_STEREO_DAC_VOL,         /*0x0505*/0x0909},    //default stereo DAC volume to 0db
...
struct snd_soc_codec_driver soc_codec_dev_rt5621 = {
	.probe = 	rt5621_probe,
...
static int rt5621_i2c_shutdown(struct i2c_client *client)
{
	...
	//printk( "enter %s\n", __func__);	
	rt5621_set_bias_level(rt5621_codec, SND_SOC_BIAS_OFF);
}
